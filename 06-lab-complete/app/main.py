...
class AskRequest(BaseModel):
    ...
    order_id: str | None = Field(None, description="Optional order ID (ORD-xxx) for BaSau Food context")
    session_id: str | None = Field(None, description="Optional session ID for multi-turn conversation")
